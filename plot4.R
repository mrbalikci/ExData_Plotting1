...
globalRcPo <- as.numeric(subsetData$Global_reactive_power)
...
# fixing the plots
par(mfrow=c(2,2))
plot(dateTime, globalAcPo, type="l", xlab="", ylab="Global Active Power")
...
plot(dateTime, globalRcPo, type="l", xlab="datetime", ylab="Global_reactive_power")

# converting into png file
png("plot4.png", width=480, height=480) # copy my plot to a PNG file in working directory 
