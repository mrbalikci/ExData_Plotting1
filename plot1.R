...
hist(globalAcPo, col="red", main = "Global Active Power", xlab="Global Active Power (kilowatts)")

# converting into png file
dev.copy(png, file="plot1.png", width=480, height=480) # copy my plot to a PNG file in working directory 
